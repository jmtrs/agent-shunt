...
`--budget-tokens` (default 12000), `--context-lines` (default 8), `--max-hits` (default 200), `--model <id>` override the retrieval envelope when chunks are truncated or the repo is large.
